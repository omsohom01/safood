...
export const HamburgerMenu: React.FC<HamburgerMenuProps> = ({ currentRoute }) => {
  ...
  const navigateTo = (route: string) => {
    ...
    // Navigate after brief delay to ensure menu closes
    setTimeout(() => {
      try {
            ...
            >
              <SafeAreaView style={styles.menuContent}>
                ...
                <View style={styles.footer}>
                  <Text style={styles.footerText}>Appify 2025 • Navigation</Text>
                </View>
              </SafeAreaView>
            </LinearGradient>
          </View>
